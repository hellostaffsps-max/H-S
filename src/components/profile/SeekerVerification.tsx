...
import { Loader2, Upload, CheckCircle2, ShieldCheck, Download, Banknote, Wallet, Building2, Smartphone } from "lucide-react";
...
export default function SeekerVerification({ seekerData }: { seekerData: any }) {
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 shadow-sm">
      <div className="flex flex-col sm:flex-row items-center gap-6 justify-between mb-8">
        <div>
