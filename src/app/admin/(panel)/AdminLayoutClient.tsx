...
const navItems: NavItem[] = [
  ...
  { label: "المنشآت الموثوقة", href: "/admin/trusted-employers", icon: Star, permission: "settings_edit" },
  ...
  { label: "الأكاديمية", href: "/admin/academy", icon: BookOpen, permission: "subscriptions_manage" },
